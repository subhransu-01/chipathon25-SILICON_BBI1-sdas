...
C {pmos4.sym} 600 -270 0 0 {name=X4 model=pfet_03p3 w=1.7u l=0.3u m=1}
C {nmos4.sym} 600 -180 0 0 {name=X5 model=nfet_03p3 w=0.85u l=0.3u m=1}
...
C {pmos4.sym} 410 -290 0 0 {name=X6 model=pfet_03p3 w=1.7u l=0.3u m=1}
C {lab_wire.sym} 450 -290 2 0 {name=l16 sig_type=std_logic lab=VDD}
C {nmos4.sym} 180 10 0 0 {name=X7 model=nfet_03p3 w=0.85u l=0.3u m=1}
C {lab_wire.sym} 220 10 2 0 {name=l18 sig_type=std_logic lab=GND}
C {lab_wire.sym} 140 10 0 0 {name=l19 sig_type=std_logic lab=C}
C {vdd.sym} 430 -350 0 0 {name=l3 lab=VDD}
C {gnd.sym} 200 70 0 0 {name=l15 lab=GND}
